...
const MOUSE_Y_SNAPBACK_THRESHOLD := 1200


func enter() -> void:
	card_ui.targets.clear() #get rid of whatever we were aiming at in the array
	...
	card_ui.drop_point_detector.monitoring = false #dont let the player target the drop area
